...
# dat <- read_csv("Stack_Colorado_NM_2012_2016_imputed.csv", col_types = cols(VoterID = col_character()))
...
# CATTs from Table D.1 on Online Appendix 
att <- c(0.068, 0.046, 0.122, 0.111, 0.058, 0.070,
         0.070, 0.080, 0.059, 0.075, 0.068, 0.074, 0.048, 0.080)
se  <- c(0.003, 0.001, 0.003, 0.004, 0.003, 0.002, 
         0.003, 0.006, 0.002, 0.007, 0.003, 0.003, 0.003, 0.003)
