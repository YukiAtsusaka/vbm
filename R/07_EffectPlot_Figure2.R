...
catt <- c(0.105, 0.095, 0.099, 0.053) # 14-Infreq, 14-freq, 16-Infreq, 16-freq
se  <- c(0.002, 0.003, 0.002, 0.002) # Infreq, Freq
...
catt <- c(0.081, 0.112, 0.122, 0.046) # 14-Infreq, 14-freq, 16-Infreq, 16-freq
se  <- c(0.003, 0.003, 0.003, 0.001) # Infreq, Freq
...
catt <- c(0.096,0.091,0.119, 0.085, 0.046, 0.111) # 14-Y, 14-M, 14-O, 16-Y, 16-M, 16-O
...
catt <- c(0.109,0.104,0.102, 0.111, 0.058, 0.070) # 14-Y, 14-M, 14-O, 16-Y, 16-M, 16-O
se   <- c(0.004,0.003,0.002, 0.004, 0.003, 0.002)  # 14-Y, 14-M, 14-O, 16-Y, 16-M, 16-O
