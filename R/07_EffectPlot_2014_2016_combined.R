...
{pdf("CATTPlot_Combined.pdf", width=10, height=7)
...
text(x=ratio*3.3,y=0.135, labels="VBM Effects in 2014 (Combined Control Units)", font=2, cex=1.2)
...
text(x=ratio*3.3,y=0.135, labels="VBM Effects in 2016 (Combined Control Units)", font=2, cex=1.2)
text(x=ratio*0.5,y=att[1]-0.01, labels="All Voter", font=2)
text(x=ratio*2, y=att[2]-0.01, labels="Frequent Voter", font=2)
text(x=ratio*3, y=att[3]+0.01, labels="Infrequent Voter", font=2)
text(x=ratio*4, y=att[4]-0.01, labels="U40", font=2)
