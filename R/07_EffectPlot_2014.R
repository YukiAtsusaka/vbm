...
att <- c(0.075, 0.073, 0.075, 0.042, 0.066, 0.115, 
         0.067, 0.062, 0.091, 0.094, 0.068, 0.068, 0.049, 0.079)
...
# CATTs from Table D.1 on Online Appendix 
att <- c(0.083, 0.099, 0.058, 0.051, 0.089, 0.100,
         0.078, 0.100, 0.083, 0.105, 0.082, 0.077, 0.068, 0.087)
